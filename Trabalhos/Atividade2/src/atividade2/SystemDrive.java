...
public abstract class SystemDrive {
     ...
     */
    private static final HashMap<String, Membro> mapaMembro = new HashMap<>();
    /**
     * Parametro String que guarda path para uma file ("arquivo_super_Secreto_nao_abrir.csv")
     */
    private static final String csvPath = "arquivo_super_Secreto_nao_abrir.csv";
    /**
    ...
    private static boolean menuPrograma() {
        ...
        switch (caseVar) {
            ...
            case 5:     // Toggle no horarioAtualTrabalho REGULAR, EXTRA
